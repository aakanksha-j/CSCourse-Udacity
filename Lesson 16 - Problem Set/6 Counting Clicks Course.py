...
#Incorrect. Your index contains too many entries for seedpage 'http://other.page/morestuff.html' when the pages and urls are as follows:
#[ ["http://some.page/stuff.html","Good morning"],
#["http://other.page/morestuff.html", 'Good night, sleep tight, go to bed and dream of Python']
...
def add_to_index(index, keyword, url):
    # Format of index: [[keyword,[[url,0],[url,o],..]],...]
    for entry in index:
        if entry[0] == keyword:
    ...
    index.append([keyword, [[url,0]]]) # added square brackets to make a list of urls with clicks instead of list of only url strings.
...
quite good at  <a href="http://www.udacity.com/cs101x/kicking.html" good good good >kicking</a>.
</body> </html>'''
