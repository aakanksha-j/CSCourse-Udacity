...
def crawl_web(seed,max_depth):
    ...
    while toCrawl and depth<max_depth:
        ...
        if page not in Crawled:
            ...
            Crawled.append(page)
            if Crawled[-1]==lastLink and toCrawl:
                depth=depth+1
                lastLink=toCrawl[-1]
    return Crawled

crawledLinks= crawl_web("http://www.udacity.com/cs101x/index.html",0)
for i in crawledLinks:
    print i
#>>> ['http://www.udacity.com/cs101x/index.html']

crawledLinks= crawl_web("http://www.udacity.com/cs101x/index.html",1)
for i in crawledLinks:
    print i
#>>> ['http://www.udacity.com/cs101x/index.html',
...
crawledLinks= crawl_web("http://www.udacity.com/cs101x/index.html",50)
for i in crawledLinks:
    print i
#>>> ['http://www.udacity.com/cs101x/index.html',
#>>> 'http://www.udacity.com/cs101x/flying.html',
...
crawledLinks= crawl_web("http://top.contributors/forbiddenvoid.html",2)
for i in crawledLinks:
    print i
